...
这就要说一说 `WakeLockSentinel` 对象了，该对象是`navigator.wakeLock.request('screen')`这个Promise执行后的返回值。
...
```text
此为转载文章 原链接为：https://www.zhangxinxu.com/wordpress/2024/03/js-screen-wake-lock-api/
```